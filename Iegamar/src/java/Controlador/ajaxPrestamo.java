 ...
 * @author Gamani Sai
 */
@WebServlet(name = "ajaxPrestamo", urlPatterns = {"/ajaxPrestamo"})
public class ajaxPrestamo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
                ...
                Logger.getLogger(ajaxPrestamo.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
